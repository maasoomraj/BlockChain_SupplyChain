        ...
        <div>
            <div className = 'Transaction'>
                ...
                <div>
                    ...
                    <div>From : {input.from.substring(0,50)} | Product : {input.product} | Quantity : {input.quantity} </div>
                    <div>To : {input.to.substring(0,50)} | Pending Amount : {input.amount} </div>
                </div>
                : ''}
                ...
                <div>
                    ...
                    <div>From : {input.from.substring(0,50)} | Product : {input.product} | Quantity : {input.quantity} </div>
                    <div>To : {input.to.substring(0,50)} | Paid Amount : {input.amount} </div>
                </div>
                : ''}
